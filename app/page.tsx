				...
				<div className="w-[85%] p-10 pl-0 rounded-r-[5rem] bg-primary-blue">
					...
					<div className="flex flex-row mt-2">
						...
						<p className="text-lg w-2/3">
							There will be individual winners and team winners.
							The individual score = (# of speed round questions
							correct) + 2 * (# of target round questions
							correct). The team score = # of team round questions
							correct. If two teams tie for the team score, then
							individual scores will be considered as a
							tiebreaker.
						</p>
					</div>
					...
					<div className="flex flex-row mt-2">
						...
						<ul className="text-lg mt-2 space-y-2 w-5/6">
							...
							<li className="list-disc">
								No giving or accepting unauthorized assistance
								of any kind.
							</li>
							<li className="list-disc">
							...
							<li className="list-disc">
								No use of AI, machine learning tools, or
								automated problem solvers (e.g., ChatGPT,
					...
					<div className="flex flex-row mt-2">
						...
						<ul className="text-lg mt-2 space-y-2 w-5/6">
							...
							<li className="list-disc">
								Students must register by the deadline - May
								8th.
							</li>
						</ul>
					</div>

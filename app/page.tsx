        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="md:flex md:items-center md:justify-between">
            <div className="py-4 md:py-10 px-4 md:px-10">
              <h1 className="text-[#8a8a8d] text-5xl md:text-6xl font-bold mb-2">
                NC(SMC)<sup>2</sup>
              </h1>
              <h3 className="text-[#346094] text-xl md:text-2xl font-semibold mb-2">
                North Carolina School of Science and Mathematics
              </h3>
              <h4 className="text-[#d57e00] text-lg md:text-xl font-medium mb-4">
